...
export const Footer = () => {
  return (
    <div className={`sm:flex text-center justify-between items-center bg-gradient-to-b from-indigo-800 to-indigo-900 w-full px-7 sm:px-14 py-3 mt-5 sm:mt-0 lg:fixed lg:bottom-0`}>
        <Logo className=""/>
