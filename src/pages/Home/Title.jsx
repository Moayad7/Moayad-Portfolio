...
export const Title = () => {
  return (
    <div className='lg:h-80 grid items-center  border-b-2 border-dashed border-indigo-600 py-9 md:py-14 lg:py14 order-first sm:order-first lg:order-2'>
        ...
        <div className='grid grid-cols-3 px-1 xl:px-14'>
