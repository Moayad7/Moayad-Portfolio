...
const Index = () => {
  ...
  return (
    <motion.div 
      ref={constraintsRef}
      className='h-80 border-b-2 border-dashed border-indigo-600 text-4xl sm:text-3xl text-indigo-600 items-center h-60 lg:h-full  w-full flex  justify-center overflow-hidden'
    >
